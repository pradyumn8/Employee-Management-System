    ...
    return (
        <div className='min-h-screen flex flex-col md:flex-row'>
            ...
            <div className='mb-8'>
                ...
                <p className='text-slate-500 text-sm sm:text-base mt-1'>{subtitle}</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <button type='submit' disabled={loading} className='w-full py-3 bg-linear-to-r from-indigo-600 to-indigo-500 text-white rounded-md text-sm font-semibold hover:to-indigo-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center'>
                    {loading && <Loader2Icon size={16} className='animate-spin h-4 w-4 mr-2' />}
                    Sign In
                </button>
            </form> 
            </div>
